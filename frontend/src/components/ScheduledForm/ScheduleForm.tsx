  ...
  return (
    <div className="p-6 max-w-xl mx-auto bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button
          type="submit"
          className="w-full !bg-[linear-gradient(180deg,#0098C9_0%,#0085B1_9.51%,#007399_37%,#007CA5_55.5%,#008DBB_100%)] hover:!bg-white hover:!text-black text-white font-medium py-2 px-4 rounded transition-colors"
          >
          Submit
        </button>
      </form>
